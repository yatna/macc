...
#View to delete a selected Post
...
class ListAppUsersView(LoginRequiredMixin, ListView):
    ...
    def get_queryset(self):
        with urllib.request.urlopen("https://rawgit.com/yatna/0e6b1ce2435de3e10a779aad40b4375b/raw/Malaria_users.json") as url:
            ...
            # data is of type - List of dictionaries eg [{name:'yatna',email:'yatnavermaa@gmail.com',age=21,gender='Male',medicineType='Malrone'},
            #{name:'annie', email:'shmulders@gmail.com', age=21, gender='female', medicineType='Mefloquine'}...]
            for user in data:
                #Create an instance of model only if similar does not exist else get the previous one
