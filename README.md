<h1>Malaria App Project [![Build Status](https://travis-ci.org/Nerdylicious/app-web-server.svg?branch=master)](https://travis-ci.org/Nerdylicious/app-web-server)</h1>
