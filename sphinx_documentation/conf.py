...
import django
os.environ['DJANGO_SETTINGS_MODULE'] = 'infohub.settings'
django.setup()
...
man_pages = [
    (master_doc, 'macc', 'MACC Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'MACC', 'MACC Documentation',
     author, 'MACC', 'One line description of project.',
     'Miscellaneous'),
]
